...
class Color(models.Model): 
    id_color  = models.IntegerField(max_length=3,primary_key=True)
    nom_color = models.CharField(max_length=30, null=True)

class Pais(models.Model): 
    id_pais  = models.IntegerField(max_length=3, primary_key=True)
    nom_pais = models.CharField(null=True, max_length=15)

class Region(models.Model): 
    id_region  = models.IntegerField(max_length=3, primary_key=True)
...
class Provincia(models.Model): 
    id_prov   = models.IntegerField(max_length=3, primary_key=True)
    nom_prov  = models.CharField(null=True, max_length=30)
    id_region = models.ForeignKey(Region, null=True, on_delete=models.CASCADE)


class Comuna(models.Model): 
    id_com  = models.IntegerField(max_length=3, primary_key=True ,)
...
class Localizacion(models.Model): 
    id_localizacion = models.IntegerField(max_length=3, primary_key=True)
...
class Cliente(models.Model): 
    rut_cli         = models.IntegerField(max_length=10, primary_key=True)
    ...
    num_cel         = models.IntegerField(max_length=9)
    id_localizacion = models.ForeignKey(Localizacion, null=True, on_delete=models.CASCADE)

class Tipo_pago(models.Model): 
    id_tipo_pago  = models.IntegerField(max_length=2, primary_key=True)
    nom_tipo_pago = models.CharField(null=True, max_length=30)

class Temporada(models.Model): 
    id_temp   = models.IntegerField(max_length=2, primary_key=True)
    temporada = models.CharField(null=True, max_length=20)

class Especie(models.Model): 
    id_esp  = models.IntegerField(max_length=3, primary_key=True)
    nom_esp = models.CharField(null=True, max_length=15)

class TipoProducto(models.Model): 
    id_tipo        = models.IntegerField(max_length=3, primary_key=True)
    especificacion = models.CharField(max_length=200, null=True)

class Planta(models.Model): 
    id_planta  = models.IntegerField(max_length=3, primary_key=True)
...
class Sucursal(models.Model): 
    id_sucursal     = models.IntegerField(max_length=3, primary_key=True)
    nom_sucursal    = models.CharField(null=True, max_length=20)
    direccion       = models.CharField(null=True, max_length=20)
    id_localizacion = models.ForeignKey(Localizacion, null=True, on_delete=models.CASCADE)

class Producto(models.Model): 
    id_prod  = models.IntegerField(max_length=3, primary_key=True)
    nom_prod = models.CharField(max_length=30, null=True)
    precio   = models.IntegerField(max_length=6, null=True)
    cantidad_prod   = models.IntegerField(max_length=6, null=True)
    id_color = models.ForeignKey(Color, null=True, on_delete=models.CASCADE)
    id_tipo  = models.ForeignKey(TipoProducto, null=True, on_delete=models.CASCADE)
    OPCION_ENTREGA_CHOICES = (
        ('retiro', 'Retiro'),
        ('despacho', 'Despacho'),
    )
    opcion_entrega = models.CharField(max_length=30, null=True, choices=OPCION_ENTREGA_CHOICES)
...
class Macetero(models.Model): 
    id_macetero   = models.IntegerField(max_length=3, primary_key=True)
...
class TipoFer(models.Model): 
    id_tipo_Fer    = models.IntegerField(max_length=3, primary_key=True)
...
class Fertilizante(models.Model): 
    id_fer   = models.IntegerField(max_length=3, primary_key=True)
...
class Cargo(models.Model): 
    id_cargo    = models.IntegerField(max_length=3, primary_key=True)
...
class Empleado(models.Model): 
    id_emp             = models.IntegerField(max_length=10, primary_key=True)
    ...
    salario            = models.IntegerField(max_length=7)
...
class Espacio_Bodega(models.Model): 
    id_espacio     = models.IntegerField(max_length=3, primary_key=True)
    fila           = models.IntegerField(max_length=7)
...
class Boleta(models.Model): 
    id_boleta    = models.IntegerField(max_length=3, primary_key=True)
    ...
    total_pago   = models.IntegerField(max_length=8)
    fecha        = models.DateField
    id_emp       = models.ForeignKey(Empleado, null=True, on_delete=models.CASCADE)
    id_sucursal  = models.ForeignKey(Sucursal, null=True, on_delete=models.CASCADE)
    
class Boleta_Detalle(models.Model): 
    id_boleta_det = models.IntegerField(max_length=3, primary_key=True)
    id_prod       = models.ForeignKey(Producto, null=True, on_delete=models.CASCADE)
    precio        = models.IntegerField(max_length=12)
    cantidad      = models.IntegerField(max_length=3)
    total         = models.IntegerField(max_length=12)

class Compra(models.Model): 
    id_compra    = models.IntegerField(max_length=3, primary_key=True)
    id_tipo_pago = models.ForeignKey(Tipo_pago, null=True, on_delete=models.CASCADE)
    rut_cli      = models.ForeignKey(Cliente, null=True, on_delete=models.CASCADE)
    total_pago   = models.IntegerField(max_length=8)
    fecha        = models.DateField
...
class Guia_Despacho(models.Model): #guia despacho
    id_gd        = models.IntegerField(max_length=3, primary_key=True)
    id_tipo_pago = models.ForeignKey(Tipo_pago, null=True, on_delete=models.CASCADE)
    rut_cli      = models.ForeignKey(Cliente, null=True, on_delete=models.CASCADE)
...
class Conductor(models.Model): 
    id_conduc    = models.IntegerField(max_length=3, primary_key=True)
    nom_con      = models.CharField(max_length=30, null= True)
    apellido_con = models.CharField(max_length=30, null=True)
    rut_con      = models.IntegerField(max_length=10, null=True)

class Ruta(models.Model): 
    id_ruta         = models.IntegerField(max_length=3,primary_key=True)
    id_localizacion = models.ForeignKey(Localizacion, null=True, on_delete=models.CASCADE)

class Camion(models.Model): 
    id_camion     = models.IntegerField(max_length=3,primary_key=True)
    patente       = models.CharField(max_length=8,null=True)
    id_conduc     = models.ForeignKey(Conductor, null=True, on_delete=models.CASCADE)
    cantidad_prod = models.IntegerField(max_length=7, null=True)
...
# nuevo_producto = Producto(id_prod=1,nom_prod='Producto A',precio=1000,cantidad_prod= 10,id_color=new_color,id_tipo=tipo_producto1, opcion_entrega='Retiro,Despacho')
# nuevo_producto.save()
